...
def generate_face_replacement_page(child_image_bytes: bytes, template_image_bytes: bytes, page_number: int = 1, is_cover_page: bool = False, child_name: str = None, book_name: str = None, canonical_reference_bytes: bytes = None, view_type: str = None, identity_info: dict = None, template_expression_override: dict = None) -> bytes:
    ...
    try:
        ...
        identity_preservation_section = (
            ...
            f"• Does it look like the SAME CHILD just in illustrated form? → Must be YES\n\n"
            ...
            f"The face should look like THIS SPECIFIC CHILD was drawn into the storybook,\n"
            f"not like a random child who vaguely resembles them.\n\n"
        )
        ...
        chatgpt_prompt = (
            ...
            "=== PRIMARY GOAL ===\n"
            "Replace the face in IMAGE 1 (storybook illustration) with the face from IMAGE 2 (child photo).\n"
            ...
            "The face must look like it NATURALLY BELONGS in the illustration - as if the child was drawn into the storybook.\n\n"
            "=== IMAGE 1 — TEMPLATE (STORYBOOK ILLUSTRATION) ===\n"
            "This is the storybook illustration. PRESERVE EVERYTHING outside the face/hair/neck area:\n"
            ...
            "=== ARTISTIC STYLE MATCHING (CRITICAL FOR NATURAL INTEGRATION) ===\n"
            "The face must be RENDERED IN THE SAME ARTISTIC STYLE as IMAGE 1:\n"
            "• Match the illustration's rendering technique (watercolor, digital painting, etc.)\n"
            "• Match the brush stroke style and texture\n"
            "• Match the color saturation and palette\n"
            "• Match the level of detail (not photorealistic, but illustrated)\n"
            "• Match the lighting and shadow rendering style\n"
            "• Match the edge softness/hardness\n"
            "• The face should look like it was DRAWN in the same style, not pasted in\n"
            "• Preserve the child's unique features but render them with the illustration's artistic techniques\n"
            "• The face should feel like a natural part of the illustration, not a photo placed on top\n\n"
            ...
            "• Maintain sharp, well-defined facial features even when matching the illustration style\n"
            ...
            "• The face itself must maintain its natural proportions - only the integration with the illustration style changes\n\n"
            "=== SEAMLESS INTEGRATION REQUIREMENTS ===\n"
            "The face must blend NATURALLY into the illustration:\n"
            ...
            "• Maintain visual harmony with the rest of the illustration\n"
            ...
            "• Hands should match the illustration style while maintaining correct anatomy\n"
            ...
            f"4) Render those features in IMAGE 1's artistic style - preserve identity but match illustration technique\n"
            ...
            "9) Match the illustration's artistic rendering style (brush strokes, color palette, lighting)\n"
            "10) Ensure the face looks like it NATURALLY BELONGS in the illustration\n"
            "11) The result should feel like the child was drawn into the storybook, not like a photo was pasted\n"
            ...
            f"✓ Face matches IMAGE 1's artistic style (illustrated, not photorealistic)\n"
            f"✓ Face looks like it NATURALLY BELONGS in the illustration\n"
            ...
            "✗ Do NOT make the face look photorealistic - it must match the illustration style\n"
            ...
            "✗ Do NOT render the face as a photo - it must be illustrated in the template's style\n"
            ...
            f"The child looks like they were drawn into the storybook while remaining\n"
            f"completely recognizable as themselves, with anatomically correct hands."
        )
